...
async def install_agent(
    ...
    if req.version:
        ...
        # Temporarily set agent's latest_version to the requested version for config gen
        agent.latest_version = target_version
        agent.latest_version_id = target_version.id
